...
**欢迎非商业 DIY；销售预装成品、收费代刷、批量销售等商业用途须另行书面授权。**
个人工位自用、学习修改和免费分享允许。完整条款见 [LICENSE](LICENSE)，第三方组件例外见下方说明。
...
项目自有部分采用 [赛博核桃非商业 DIY 源码许可 1.0](LICENSE)：允许个人学习、修改、自用和非商业免费分享；销售预装设备、收费代刷/组装/定制、商业捆绑等需另行书面授权。分享时须附许可并保留来源，修改版应标明修改。商业授权请通过本仓库 Issues 联系维护者；申请不等于授权。

这是“源码开放”，不是 OSI 定义的开源，也不是 MIT/GPL。字体遵循 `assets/OFL.txt`，pypinyin 和 XPowersLib 保留各自许可证。本许可不限制这些第三方许可证已授予的权利。素材包含用户参考图和 AI 生成内容；仅许可项目方有权授权的部分，不额外授予未知第三方素材的商业权利。该许可亦适用于此前版本中的项目自有部分，但不撤回此前有效授权。
